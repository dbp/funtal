...
(* OASIS_START *)
(* DO NOT EDIT (digest: f20d0ec4da186b9fab29a21a941e0951) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ftal", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "web.ml"});
               Executable
                 ({
                     cs_name = "driver";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = ".";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ftal"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "driver.ml"});
               Executable
                 ({
                     cs_name = "test_ftal";
                     cs_data = PropList.Data.create ();
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("mv", ["_build/web.js"; "artifact/"])))
                 ]
            };
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "g\182\189\149o\255b\202\251!2\207P\016\173@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
